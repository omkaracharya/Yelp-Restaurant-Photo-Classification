...
test_photo_to_biz_ids = pd.read_csv(DATA_HOME + 'test_photo_to_biz.csv')
...
for business_id in business_ids:
    ...
    feature = list(
        np.mean(np.asarray(test_features_file['feature'][images_for_business_id[0]:(images_for_business_id[-1] + 1)]),
                axis=0))
